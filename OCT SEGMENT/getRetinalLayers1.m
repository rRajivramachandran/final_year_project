...
if nargin < 2        
    ...
    params.rnfl_0 = 0.05;%  0.01;
    params.rnfl_1 = 0.3; %   0.1;
    params.iplinl_0 = 0.6;
    params.iplinl_1 = 0.2;
...
retinalLayerSegmentationOrder = {'roughILMandISOS' 'ilm' 'isos' 'rpe' 'inlopl' 'rnfl' 'iplinl' 'oplonl'};
...
if isPlot,
    ...
    layersToPlot = {'ilm' 'rnfl' };% 'rpeSmooth'}; %
    hOffset =       [15    0   ]; % for displaying text
