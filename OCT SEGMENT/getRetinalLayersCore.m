...
switch layerName
    ...
    case {'rnfl' 'inlopl' 'ilm' 'isos' 'oplonl' 'iplinl' 'rpe'}
...
for k = 2:szImg(2)-1
    ...
    switch layerName
        ...
        case {'rnfl'}
            ...
            startInd = startInd0 - ceil(params.rnfl_0*(endInd0-startInd0));
            endInd = endInd0 - round(params.rnfl_1*(endInd0-startInd0));
        ...
        case {'iplinl'}
            ...
            % 'rnfl' and 'inlopl'.
            indPathX = find(rPaths(strcmp('rnfl',{rPaths.name})).pathY==k);
            startInd0 = rPaths(strcmp('rnfl',{rPaths.name})).pathX(indPathX(1));
            indPathX = find(rPaths(strcmp('inlopl',{rPaths.name})).pathY==k);
            endInd0 = rPaths(strcmp('inlopl',{rPaths.name})).pathX(indPathX(1));
